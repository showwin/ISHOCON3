...
echo 'export BENCH_TEAM_NAME="${each.value}"' >> /home/ishocon/env.sh
echo 'export BENCH_SCOREBOARD_APIGW_URL="${aws_apigatewayv2_stage.scoreboard.invoke_url}"' >> /home/ishocon/env.sh
